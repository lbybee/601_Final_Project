...
\definecolor{cmeet}{HTML}{E31A1C}
\definecolor{cmideast}{HTML}{1F78B4}
\definecolor{cstaff}{HTML}{A6CEE3}
\definecolor{cpolitics}{HTML}{33A02C}
\definecolor{cterror}{HTML}{B2DF8A}
\definecolor{cforeign}{HTML}{FB9A99}
\definecolor{cpress}{HTML}{FF7F00}
\definecolor{chill}{HTML}{6A3D9A}
\definecolor{ccommu}{HTML}{CAB2D6}
\definecolor{ccomm}{HTML}{FDBF6F}
