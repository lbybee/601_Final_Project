...
\begin{figure}[h]
\centering
\subfigure[Israel]{\label{fig:t1}\includegraphics[width=29mm]{../images/time_plot6.pdf}}
\subfigure[Elections]{\label{fig:t2}\includegraphics[width=29mm]{../images/time_plot11.pdf}}
\subfigure[Libya]{\label{fig:t3}\includegraphics[width=29mm]{../images/time_plot18.pdf}}
\subfigure[Afghanistan]{\label{fig:t4}\includegraphics[width=29mm]{../images/time_plot27.pdf}}
\subfigure[Int. Dev.]{\label{fig:t5}\includegraphics[width=29mm]{../images/time_plot23.pdf}}
\subfigure[Obama]{\label{fig:t6}\includegraphics[width=29mm]{../images/time_plot25.pdf}}
...
\begin{frame}{Multinomial Regression Results}
